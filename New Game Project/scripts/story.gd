...
func _process(delta):
	...
	if Global.round == 3 and Global.plant_round == true and Global.round_read == false:
		...
		$Button.visible = true
		Global.reading_story = true
	if Global.round == 4 and Global.plant_round == true and Global.round_read == false and Global.score <= 10:
	...
	if Global.round == 4 and Global.plant_round == true and Global.round_read == false and Global.score > 10:
		...
		$Button.visible = true
		Global.reading_story = true
	if Global.round == 5 and Global.plant_round == true and Global.round_read == false and Global.score > 10:
